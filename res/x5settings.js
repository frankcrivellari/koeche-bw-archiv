(function ( $, x5engine ) {
	...
	s.siteId = 'E21FB63F84711B835B32209657BFC592';
	...
	b.push(function () {
		x.stickyBar({
			enabledBreakpoints: ['545117060ae3f2b213d760585572b34a','d2f9bff7f63c0d6b7c7d55510409c19b','72e5146e7d399bc2f8a12127e43469f1','5ecdcca63de80fd3d4fbb36295d22b7d']
		});
	});
	...
	if (s.imAdv.show) {
		...
		s.imAdv.message = { media: { "type": "image", "url": x5engine.settings.currentPath + "images/Folie1_isdpf81r.JPG", "width": 1280, "height": 720 }, effect: 'animated flash advertising' };
		s.imAdv.message.media.onclick = function () { x5engine.utils.imPopUpWin('https://mackes.eu/httpdocs/talentschmiede2018.html', '', -1, -1, true); };
	...
	// BreakPoints
	s.breakPoints.push({"name": "Desktop", "hash": "545117060ae3f2b213d760585572b34a", "start": "max", "end": 1013.0, "fluid": false});
	s.breakPoints.push({"name": "Breakpoint 1", "hash": "d2f9bff7f63c0d6b7c7d55510409c19b", "start": 1012.9, "end": 720.0, "fluid": false});
