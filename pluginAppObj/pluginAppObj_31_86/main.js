function animatedimage_pluginAppObj_31_86() {
    ...
    var hoverEvent_pluginAppObj_31_86; 
    ...
    $(document).ready(function(){
        ...
        switch("mouseover"){
            ...
            case "timer":
                ...
                break;
            case "mouseover":
                $('#iandt_pluginAppObj_31_86 .wrapper').hover(function(e){
                    hoverEvent_pluginAppObj_31_86 = true;
                    $(this).addClass('back-visible'); 
                    setTimeout(function(){ 
                        hoverEvent_pluginAppObj_31_86 = false; 
                    }, 100);
                }, function(){
                    hoverEvent_pluginAppObj_31_86 = false;
        ...
        if(isMobile && "appear-left" == "none"){   
            ...
            $('#iandt_pluginAppObj_31_86 .wrapper a').each(function(){
                // Cache event
                ...
                $(this).click(function(){    
                    if(!hoverEvent_pluginAppObj_31_86 && 
                        $('#iandt_pluginAppObj_31_86 .wrapper').hasClass('back-visible')) {
