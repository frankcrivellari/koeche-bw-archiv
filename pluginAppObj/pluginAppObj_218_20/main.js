function download_button_pluginAppObj_218_20() {
	...
	x5engine.boot.push(function(){
	    ...
	    if(false){
	    	setBubbleValue(23);
	    	$("#pluginAppObj_218_20 .downloadbtn").one("click", function(){
	    		newDownload(24, true);
	    	});
	    }
	    else{
			...
			$.ajax({
		        url: 'pluginAppObj/pluginAppObj_218_20/download.php?action=total',
		        type: 'POST'
	    	})
	        .fail( function() {
	        	setBubbleValue(23)
		    ...
		    $("#pluginAppObj_218_20 .downloadbtn a").on("click", function(){

		    	var countToShow = $("#pluginAppObj_218_20 .bubble").html();
		    	var animateBubble = false;
		    	if(!($.imCookie("download_count_pluginAppObj_218_20") == "counted")){
					countToShow++;
					animateBubble = true;
		    	}
	...
	function newDownload(value, animateBubble){
		...
		$("#pluginAppObj_218_20 .bubble").html(value);
		// Text after download, now not implemented
		// $("#pluginAppObj_218_20 .downloadbtn a").html("< ? wsx5 document.write(parameters.after_caption.value) ? >");
		if(animateBubble)
			$("#pluginAppObj_218_20 .bubble").addClass("newdownload");
	}

	function resizeButton(){
		var button = $("#pluginAppObj_218_20 .downloadbtn");
		var bubble = $("#pluginAppObj_218_20 .bubble");
		var containerWidth = $("#pluginAppObj_218_20").parent().width();
		var buttonBorders = 4;
		var bubbleBorders = 2;
		var buttonWidth = 154;
		var bubbleWidth = 102;
		...
		var spikeDim = 10;
		var wrapper = $("#download_button_wrapper_pluginAppObj_218_20");
