function animatedimage_pluginAppObj_31_99() {
    ...
    var hoverEvent_pluginAppObj_31_99; 
    ...
    $(document).ready(function(){
        ...
        switch("mouseover"){
            ...
            case "timer":
                ...
                break;
            case "mouseover":
                $('#iandt_pluginAppObj_31_99 .wrapper').hover(function(e){
                    hoverEvent_pluginAppObj_31_99 = true;
                    $(this).addClass('back-visible'); 
                    setTimeout(function(){ 
                        hoverEvent_pluginAppObj_31_99 = false; 
                    }, 100);
                }, function(){
                    hoverEvent_pluginAppObj_31_99 = false;
        ...
        if(isMobile && "appear-left" == "none"){   
            ...
            $('#iandt_pluginAppObj_31_99 .wrapper a').each(function(){
                // Cache event
                ...
                $(this).click(function(){    
                    if(!hoverEvent_pluginAppObj_31_99 && 
                        $('#iandt_pluginAppObj_31_99 .wrapper').hasClass('back-visible')) {
