function download_button_pluginAppObj_228_49() {
	...
	x5engine.boot.push(function(){
	    ...
	    if(false){
	    	setBubbleValue(16);
	    	$("#pluginAppObj_228_49 .downloadbtn").one("click", function(){
	    		newDownload(17, true);
	    	});
	    }
	    else{
			...
			$.ajax({
		        url: 'pluginAppObj/pluginAppObj_228_49/download.php?action=total',
		        type: 'POST'
	    	})
	        .fail( function() {
	        	setBubbleValue(16)
		    ...
		    $("#pluginAppObj_228_49 .downloadbtn a").on("click", function(){

		    	var countToShow = $("#pluginAppObj_228_49 .bubble").html();
		    	var animateBubble = false;
		    	if(!($.imCookie("download_count_pluginAppObj_228_49") == "counted")){
					countToShow++;
					animateBubble = true;
		    	}
	...
	function setBubbleValue(value){
		$('#pluginAppObj_228_49 .bubble').html(value);$('#pluginAppObj_228_49 .bubble').fadeIn();
	}

	function newDownload(value, animateBubble){

		$("#pluginAppObj_228_49 .bubble").html(value);
		// Text after download, now not implemented
		// $("#pluginAppObj_228_49 .downloadbtn a").html("< ? wsx5 document.write(parameters.after_caption.value) ? >");
		if(animateBubble)
			$("#pluginAppObj_228_49 .bubble").addClass("newdownload");
	}

	function resizeButton(){
		var button = $("#pluginAppObj_228_49 .downloadbtn");
		var bubble = $("#pluginAppObj_228_49 .bubble");
		var containerWidth = $("#pluginAppObj_228_49").parent().width();
		var buttonBorders = 2;
		var bubbleBorders = 2;
		var buttonWidth = 75;
		var bubbleWidth = 42;
		...
		var spikeDim = 10;
		var wrapper = $("#download_button_wrapper_pluginAppObj_228_49");
