function download_button_pluginAppObj_189_78() {
	...
	x5engine.boot.push(function(){
	    ...
	    if(false){
	    	setBubbleValue(1);
	    	$("#pluginAppObj_189_78 .downloadbtn").one("click", function(){
	    		newDownload(2, true);
	    	});
	    }
	    else{
			...
			$.ajax({
		        url: 'pluginAppObj/pluginAppObj_189_78/download.php?action=total',
		        type: 'POST'
	    	})
	        .fail( function() {
	        	setBubbleValue(1)
		    ...
		    $("#pluginAppObj_189_78 .downloadbtn a").on("click", function(){

		    	var countToShow = $("#pluginAppObj_189_78 .bubble").html();
		    	var animateBubble = false;
		    	if(!($.imCookie("download_count_pluginAppObj_189_78") == "counted")){
					countToShow++;
					animateBubble = true;
		    	}
	...
	function setBubbleValue(value){
		$('#pluginAppObj_189_78 .bubble').html(value);$('#pluginAppObj_189_78 .bubble').fadeIn();
	}

	function newDownload(value, animateBubble){

		$("#pluginAppObj_189_78 .bubble").html(value);
		// Text after download, now not implemented
		// $("#pluginAppObj_189_78 .downloadbtn a").html("< ? wsx5 document.write(parameters.after_caption.value) ? >");
		if(animateBubble)
			$("#pluginAppObj_189_78 .bubble").addClass("newdownload");
	}

	function resizeButton(){
		var button = $("#pluginAppObj_189_78 .downloadbtn");
		var bubble = $("#pluginAppObj_189_78 .bubble");
		var containerWidth = $("#pluginAppObj_189_78").parent().width();
		var buttonBorders = 2;
		var bubbleBorders = 2;
		var buttonWidth = 231;
		var bubbleWidth = 92;
		...
		var spikeDim = 10;
		var wrapper = $("#download_button_wrapper_pluginAppObj_189_78");
