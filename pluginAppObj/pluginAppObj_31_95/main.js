function animatedimage_pluginAppObj_31_95() {
    ...
    var hoverEvent_pluginAppObj_31_95; 
    ...
    $(document).ready(function(){
        ...
        switch("mouseover"){
            ...
            case "timer":
                ...
                break;
            case "mouseover":
                $('#iandt_pluginAppObj_31_95 .wrapper').hover(function(e){
                    hoverEvent_pluginAppObj_31_95 = true;
                    $(this).addClass('back-visible'); 
                    setTimeout(function(){ 
                        hoverEvent_pluginAppObj_31_95 = false; 
                    }, 100);
                }, function(){
                    hoverEvent_pluginAppObj_31_95 = false;
        ...
        if(isMobile && "fade" == "none"){   
            ...
            $('#iandt_pluginAppObj_31_95 .wrapper a').each(function(){
                // Cache event
                ...
                $(this).click(function(){    
                    if(!hoverEvent_pluginAppObj_31_95 && 
                        $('#iandt_pluginAppObj_31_95 .wrapper').hasClass('back-visible')) {
